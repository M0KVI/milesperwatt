A very simple offline python script to calculate miles per watt for QRP radio operation. It can be used anywhere python is, for example using Termux on your mobile while on a mountain, without internet. 
